 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BaseStream implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaseStream';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['series_type']) && !in_array($this->container['series_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getSeriesTypeAllowableValues();
        if (!is_null($series_type) && !in_array($series_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'series_type', must be one of '%s'",
                    implode("', '", $allowedValues)
