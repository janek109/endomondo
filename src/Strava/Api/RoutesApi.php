...
class RoutesApi
{
    ...
    {
        $returnType = '\Swagger\Client\Strava\Model\Route';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Strava\Model\Route',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \Swagger\Client\Model\Route[]
     */
    public function getRoutesByAthleteId($page = null, $per_page = '30')
    {
        list($response) = $this->getRoutesByAthleteIdWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Route[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getRoutesByAthleteIdWithHttpInfo($page = null, $per_page = '30')
    {
        $returnType = '\Swagger\Client\Strava\Model\Route[]';
        $request = $this->getRoutesByAthleteIdRequest($page, $per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoutesByAthleteIdAsync($page = null, $per_page = '30')
    {
        return $this->getRoutesByAthleteIdAsyncWithHttpInfo($page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRoutesByAthleteIdAsyncWithHttpInfo($page = null, $per_page = '30')
    {
        $returnType = '\Swagger\Client\Strava\Model\Route[]';
        $request = $this->getRoutesByAthleteIdRequest($page, $per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRoutesByAthleteIdRequest($page = null, $per_page = '30')
    {
